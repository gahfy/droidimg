...
i686-w64-mingw32-gcc.exe -g -W -Wall -std=c99 -c ./utils/config_utils.c -o ./build/utils/config_utils.o
...
i686-w64-mingw32-gcc.exe ./build/utils/config_utils.o ./build/droidimg.o ./build/utils/picture_utils.o ./build/utils/string_utils.o ./build/utils/android_utils.o ./build/utils/webp_utils.o ./build/utils/png_utils.o ./build/utils/binary_utils.o ./build/utils/memory_utils.o -o ./i686/droidimg.exe "-L/temp/libwebp/lib" -lpng -lwebp -static-libgcc
