...
gcc -g -W -Wall -std=c99 -c ./utils/config_utils.c -o ./build/utils/config_utils.o
...
gcc ./build/droidimg.o ./build/utils/config_utils.o ./build/utils/picture_utils.o ./build/utils/string_utils.o ./build/utils/android_utils.o ./build/utils/webp_utils.o ./build/utils/png_utils.o ./build/utils/binary_utils.o ./build/utils/memory_utils.o -o droidimg "-L$LIBWEBP_HOME/lib" "-L$LIBPNG_HOME/lib" -lpng -lwebp